      ...
      ensurePdfTextPositions:
        - # Code listings should be left-aligned with body text, not centered.
          ...
          - subject: "Limitica"
            ...
            object: "Continua"
            page: 12
          # Chapter 2 extended margin content (page 12 - verso, left margin)
          - subject: "Quadratica"
            relation: leftOf
            object: "Formulix"
            page: 12
          - subject: "Quicksortix"
            ...
            object: "Algorithmix"
            page: 12
          # Appendix A margin content (page 17 - recto, right margin)
          - subject: "Appendorba"
            relation: rightOf
            object: "Appendixia"
            page: 17
          # Appendix B margin content (page 20 - verso, left margin)
          - subject: "Databvisual"
            relation: leftOf
            object: "Secondaria"
            page: 20
          # Margin callout position tests (EXPECTED TO FAIL)
          # Bug: .column-margin on callouts not translated to #note() for Typst
          # These callouts should be in margin but render in body instead
          - subject: "Apothegma"
            relation: rightOf
            object: "Paleontologica"
            page: 6
          - subject: "Prolegomena"
            relation: rightOf
            object: "Hermeneutica"
